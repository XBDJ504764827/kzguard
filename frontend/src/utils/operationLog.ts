...
export const operationLogActionLabelMap: Record<OperationLogAction, string> = {
  ...
  whitelist_player_updated: '编辑白名单玩家',
  whitelist_player_deleted: '删除白名单玩家',
  whitelist_restriction_added: '加入玩家限制页',
  whitelist_restriction_updated: '更新限制服务器',
  whitelist_restriction_removed: '移出玩家限制页',
